    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_hour', models.DateTimeField(default='2022-01-01 00:00:00', help_text='Hora de inicio de la reserva', verbose_name='Start time (hh:mm:ss)')),
                ('finish_hour', models.DateTimeField(default='2022-01-01 00:00:00', help_text='Hora de finalización de la reserva', verbose_name='End time (hh:mm:ss)')),
