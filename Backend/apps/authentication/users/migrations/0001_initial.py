    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'único': 'Este nombre de usuario ya está en uso.'}, help_text='Nombre de usuario, Requerido. 150 caracteres o menos.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='Username')),
                ...
                ('gender', models.CharField(choices=[('M', 'Man'), ('F', 'Female'), ('O', 'Other')], default=None, max_length=1, verbose_name='Which gender do you identify with?')),
